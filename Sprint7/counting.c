...
uint8_t count_limit = 10;          // max count for low digit. 10 for 0 - 9; 16 for hex
...
void SysTick_Handler(void)
{
    ...
    if (count < count_limit)
    {
        ...
        case 0:
            ...
            master_tx_frame = ((digit8 << 8) + nine);
            SPI_transfer_frame(&g_spi0, master_tx_frame);
            break;

        case 1:

            master_tx_frame = ((digit7 << 8) + nine);
            SPI_transfer_frame(&g_spi0, master_tx_frame);
            master_tx_frame = ((digit8 << 8) + eight);
            SPI_transfer_frame(&g_spi0, master_tx_frame);
            break;

        case 2:

            master_tx_frame = ((digit6 << 8) + nine);
            SPI_transfer_frame(&g_spi0, master_tx_frame);
            master_tx_frame = ((digit7 << 8) + eight);
            SPI_transfer_frame(&g_spi0, master_tx_frame);
            master_tx_frame = ((digit8 << 8) + seven);
            SPI_transfer_frame(&g_spi0, master_tx_frame);
            break;

        case 3:

            master_tx_frame = ((digit5 << 8) + nine);
            SPI_transfer_frame(&g_spi0, master_tx_frame);
            master_tx_frame = ((digit6 << 8) + eight);
            SPI_transfer_frame(&g_spi0, master_tx_frame);
            master_tx_frame = ((digit7 << 8) + seven);
            SPI_transfer_frame(&g_spi0, master_tx_frame);
            master_tx_frame = ((digit8 << 8) + six);
            SPI_transfer_frame(&g_spi0, master_tx_frame);
            break;
        case 4:

            master_tx_frame = ((digit4 << 8) + nine);
            SPI_transfer_frame(&g_spi0, master_tx_frame);
            master_tx_frame = ((digit5 << 8) + eight);
            SPI_transfer_frame(&g_spi0, master_tx_frame);
            master_tx_frame = ((digit6 << 8) + seven);
            SPI_transfer_frame(&g_spi0, master_tx_frame);
            master_tx_frame = ((digit7 << 8) + six);
            SPI_transfer_frame(&g_spi0, master_tx_frame);
            master_tx_frame = ((digit8 << 8) + five);
            SPI_transfer_frame(&g_spi0, master_tx_frame);
            break;

        case 5:
            master_tx_frame = ((digit3 << 8) + nine);
            SPI_transfer_frame(&g_spi0, master_tx_frame);
            master_tx_frame = ((digit4 << 8) + eight);
            SPI_transfer_frame(&g_spi0, master_tx_frame);
            master_tx_frame = ((digit5 << 8) + seven);
            SPI_transfer_frame(&g_spi0, master_tx_frame);
            master_tx_frame = ((digit6 << 8) + six);
            SPI_transfer_frame(&g_spi0, master_tx_frame);
            master_tx_frame = ((digit7 << 8) + five);
            SPI_transfer_frame(&g_spi0, master_tx_frame);
            master_tx_frame = ((digit8 << 8) + four);
            SPI_transfer_frame(&g_spi0, master_tx_frame);
            break;

        case 6:
            master_tx_frame = ((digit2 << 8) + nine);
            SPI_transfer_frame(&g_spi0, master_tx_frame);
            master_tx_frame = ((digit3 << 8) + eight);
            SPI_transfer_frame(&g_spi0, master_tx_frame);
            master_tx_frame = ((digit4 << 8) + seven);
            SPI_transfer_frame(&g_spi0, master_tx_frame);
            master_tx_frame = ((digit5 << 8) + six);
            SPI_transfer_frame(&g_spi0, master_tx_frame);
            master_tx_frame = ((digit6 << 8) + five);
            SPI_transfer_frame(&g_spi0, master_tx_frame);
            master_tx_frame = ((digit7 << 8) + four);
            SPI_transfer_frame(&g_spi0, master_tx_frame);
            master_tx_frame = ((digit8 << 8) + three);
            SPI_transfer_frame(&g_spi0, master_tx_frame);
            break;

        case 7:

            master_tx_frame = ((digit1 << 8) + nine);
            SPI_transfer_frame(&g_spi0, master_tx_frame);
            master_tx_frame = ((digit2 << 8) + eight);
            SPI_transfer_frame(&g_spi0, master_tx_frame);
            master_tx_frame = ((digit3 << 8) + seven);
            SPI_transfer_frame(&g_spi0, master_tx_frame);
            master_tx_frame = ((digit4 << 8) + six);
            SPI_transfer_frame(&g_spi0, master_tx_frame);
            master_tx_frame = ((digit5 << 8) + five);
            SPI_transfer_frame(&g_spi0, master_tx_frame);
            master_tx_frame = ((digit6 << 8) + four);
            SPI_transfer_frame(&g_spi0, master_tx_frame);
            master_tx_frame = ((digit7 << 8) + three);
            SPI_transfer_frame(&g_spi0, master_tx_frame);
            master_tx_frame = ((digit8 << 8) + two);
            SPI_transfer_frame(&g_spi0, master_tx_frame);
            break;


        case 8:
            master_tx_frame = ((digit0 << 8) + nine);
            SPI_transfer_frame(&g_spi0, master_tx_frame);
            master_tx_frame = ((digit1 << 8) + eight);
            SPI_transfer_frame(&g_spi0, master_tx_frame);
            master_tx_frame = ((digit2 << 8) + seven);
            SPI_transfer_frame(&g_spi0, master_tx_frame);
            master_tx_frame = ((digit3 << 8) + six);
            SPI_transfer_frame(&g_spi0, master_tx_frame);
            master_tx_frame = ((digit4 << 8) + five);
            SPI_transfer_frame(&g_spi0, master_tx_frame);
            master_tx_frame = ((digit5 << 8) + four);
            SPI_transfer_frame(&g_spi0, master_tx_frame);
            master_tx_frame = ((digit6 << 8) + three);
            SPI_transfer_frame(&g_spi0, master_tx_frame);
            master_tx_frame = ((digit7 << 8) + two);
            SPI_transfer_frame(&g_spi0, master_tx_frame);
            master_tx_frame = ((digit8 << 8) + one);
            SPI_transfer_frame(&g_spi0, master_tx_frame);
            break;

...
quietly set PROJECT_DIR "C:/FPGA/Libero_SoC_PF_tutorial/PF_LED_blink"
...
vcom -2008 -explicit  -work presynth "${PROJECT_DIR}/hdl/LED_ctrl.vhd"
...
vcom -2008 -explicit  -work presynth "${PROJECT_DIR}/component/work/Fabric_Top/Fabric_Top.vhd"
vcom -2008 -explicit  -work presynth "${PROJECT_DIR}/stimulus/user_testbench.vhd"
